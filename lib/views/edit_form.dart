...
class EditFormScreen extends StatefulWidget {
  ...
  const EditFormScreen({Key? key, required this.item}) : super(key: key);
...
class _EditFormScreenState extends State<EditFormScreen> {
  ...
  String imageBandOld = '';
  String signatureOld2 = '';
  String signatureOld3 = '';
  String signatureOld4 = '';
  String signatureOld5 = '';
  ...
  void setData() {
    ///FORM 1
    nameControllerForm1.text = formModel.deceasedName ?? '';
    dateInputForm1.text = formModel.dateOfDeath.toString();

    placeControllerForm1.text = formModel.placeOfDeath;
    stateController.text = formModel.stateId.toString();
    dateTimeAttachedControllerForm1.text =
        formModel.dateTimeAttached.toString();
    phoneNumberController.text = formModel.phoneNumber;

    selectedCountryId = formModel.countryId.toString();
    selectedStateId = formModel.stateId.toString();
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      await getStates(countryCode: selectedCountryId ?? '');
    });

    ///Form 2

    directorName.text = formModel.nameOfFuneralDirector;
    addressController.text = formModel.addressOfFuneralHome;
    dateInputForm2.text = formModel
        .nameFuneralDirectorOtherRepresentativeTakingCustodyDt
        .toString();
    dateInputForm2Phase2.text = formModel
        .nameCrematoryCemeteryRepresentativeCustodyDeceasedDt
        .toString();

    ///Form 3

    relationShipForm3.text =
        formModel.nameOfPersonEntitledToReceiveCrematedRemainsRelationship;

    dateInputForm3.text =
        formModel.nameOfPersonEntitledToReceiveCrematedRemainsDt.toString();

    dateInputForm3Phase3.text =
        formModel.nameOfPersonReleasingCrematedRemainsDt.toString();

    imageBand = formModel.pictureOfNumberOnBand;

    signature2 =
        formModel.nameFuneralDirectorOtherRepresentativeTakingCustodyEsign;
    signature3 =
        formModel.nameCrematoryCemeteryRepresentativeCustodyDeceasedEsign;
    signature4 = formModel.nameOfPersonEntitledToReceiveCrematedRemainsEsign;
    signature5 = formModel.nameOfPersonReleasingCrematedRemainsEsign;

    imageBandOld = imageBand;
    signatureOld2 = signature2;
    signatureOld3 = signature3;
    signatureOld4 = signature4;
    signatureOld5 = signature5;

    // relationShipForm3
    // dateInputForm3

    // dateInputForm3Phase3
  }
  ...
  getCountryList() {
    signUpViewModel.country.forEach((element) {
      ...
      if (element.id.toString() == selectedCountryId) {
  ...
  getStateList() {
    ...
    signUpViewModel.state.forEach((element) {
      ...
      if (element.id.toString() == selectedStateId) {
        selectedStateName = element.name;
      }
    });
            ...
            return SingleChildScrollView(
              child: Stack(
                children: [
                                ...
                                onPressed: () async {
                                  ...
                                  if (selector == 1) {
                                    if (_key2.currentState!.validate()) {
                                      if (dateInputForm2.text.isEmpty) {
                                      ...
                                      } else if (directorName.text.isEmpty) {
                                        CommonSnackBar.showSnackBar(
                                            title: 'Create form',
                                            message:
                                        ...
                                        CommonSnackBar.showSnackBar(
                                            title: 'Create form',
                                            message: "Please upload your sign");
                                      } else if (signature3 == "") {
                                        CommonSnackBar.showSnackBar(
                                            title: 'Create form',
                                            message: "Please upload your sign");
                                    ...
                                    if (_key3.currentState!.validate()) {
                                      if (dateInputForm3.text.isEmpty) {
                                        ...
                                        var body = {
                                          ...
                                          "deceased_name":
                                              nameControllerForm1.text.trim(),
                                          "date_of_death":
                                              dateInputForm1.text.trim(),
                                          "place_of_death":
                                              placeControllerForm1.text.trim(),
                                          "phone_number":
                                              phoneNumberController.text.trim(),
                                          if (imageBandOld != imageBand)
                                            "picture_of_number_on_band":
                                                await dio.MultipartFile
                                                    .fromFile(
                                                        imageBandFile?.path ??
                                                            '',
                                                        filename: imageBandFile
                                                            ?.name),
                                          "name_securing_band": "test",
                                          "date_time_attached":
                                              dateTimeAttachedControllerForm1
                                            ...
                                            "name_crematory_cemetery_representative_custody_deceased_esign":
                                                await dio.MultipartFile.fromFile(
                                                    ...
                                                    filename:
                                                        'signatureFile3.png'),
                                          "name_crematory_cemetery_representative_custody_deceased_dt":
                                              dateInputForm2Phase2.text.trim(),
                                          if (signatureOld4 != signature4)
                                            "name_of_person_entitled_to_receive_cremated_remains_esign":
                                                await dio.MultipartFile.fromFile(
                                                    signatureFile4?.path ?? '',
                                                    filename:
                                            ...
                                            "name_of_person_releasing_cremated_remains_esign":
                                                await dio.MultipartFile.fromFile(
                                                    ...
                                                    filename:
                                                        'signatureFile5.png'),
                                          "name_of_person_releasing_cremated_remains_dt":
                                              dateInputForm3Phase3.text.trim(),
                                        };
                                        ...
                                        formController
                                            .editFormModel(
                                                body: body,
                                                formId: formModel.id.toString())
                                            .then((value) {
                                          if (formController
                                                  .apiResponseEditForm.status ==
                                              Status.COMPLETE) {
                  ...
                  formController.apiResponseEditForm.status == Status.LOADING
                      ? Container(
                          width: Get.width,
                          height: Get.height,
